...
<svg
  id="Layer_1"
  style="enable-background:new 0 0 566.93 170.04"
...
```html
<svg xmlns="http://www.w3.org/2000/svg" fill="#FFF" viewBox="0 0 566.93 170.04">
  <path
