...
image: /assets/images/posts/contour.gif
image_width: 345
image_height: 380
tags:
  - images
...
<video controls style="max-width:100%">
  <source src="{{ site.url }}/assets/images/posts/contour.mp4" type="video/mp4">
</video>
...
If you have been following this blog, I have been talking lately about techniques to load images in a progressive way, with the [_blur up_ technique used by Medium]({{ site.url }}/medium-image-progressive-loading-placeholder/) and the use of [WebP as placeholders]({{ site.url }}/webp-placeholder-images/).
